...
const Man6 = () => {
    ...
    <View style={styles.container}>
      ...
      <View>
        <Text style={{fontSize: 17,color:'#000000',fontWeight:'600',marginLeft: 30,marginTop: 20}}>Information</Text>
      </View>
      <View style={{height:100, width: 300, backgroundColor: '#FFFFFF',marginLeft: 25,borderRadius: 30,marginTop: 10,flexDirection:'row'}}>
        <Image
      ...
      <View style={{height:130, width: 300, backgroundColor: '#FFFFFF',marginLeft: 25,borderRadius: 30,marginTop: 20}}>
